			...
			<div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4 pt-8 md:pt-0">
				<motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-8 md:mb-12">
					<div className="space-y-3 md:space-y-4 mb-6 md:mb-8">
						...
						<h2 className="text-2xl md:text-4xl font-bold text-white">Full Stack PHP Developer</h2>
						<p className="text-lg md:text-xl text-gray-400 max-w-2xl mx-auto">
							Crafting digital experiences with modern technologies and 7+ years of experience building scalable web applications.
						</p>
						<p className="text-base md:text-lg text-gray-500 max-w-2xl mx-auto">
							Currently Technical Lead at <span className="text-blue-400">Foxtek Systems</span> and previously at{' '}
							<span className="text-purple-400">Devsinc</span>
						</p>
					</div>
					<div className="flex flex-wrap justify-center gap-2 md:gap-3 mb-6 md:mb-8">
						<span className="px-3 md:px-4 py-1.5 md:py-2 bg-blue-500/10 rounded-full text-blue-400 text-xs md:text-sm">PHP/Laravel</span>
						<span className="px-3 md:px-4 py-1.5 md:py-2 bg-purple-500/10 rounded-full text-purple-400 text-xs md:text-sm">ReactJS</span>
						<span className="px-3 md:px-4 py-1.5 md:py-2 bg-teal-500/10 rounded-full text-teal-400 text-xs md:text-sm">VueJS</span>
						<span className="px-3 md:px-4 py-1.5 md:py-2 bg-blue-500/10 rounded-full text-blue-400 text-xs md:text-sm">WebSockets</span>
						<span className="px-3 md:px-4 py-1.5 md:py-2 bg-purple-500/10 rounded-full text-purple-400 text-xs md:text-sm">MySQL</span>
					</div>
				</motion.div>
